...
const AdminCourses: React.FC = () => {
 ...
 <th className="px-6 py-4 text-xs font-semibold text-warm-brown uppercase tracking-wider">Author</th>
 ...
 {loading ? (
 <tr>
 <td colSpan={4} className="px-6 py-8 text-center text-warm-brown ">
 ...
 <tr>
 <td colSpan={4} className="px-6 py-12 text-center text-warm-brown ">
 <div className="flex flex-col items-center justify-center gap-2">
 <BookOpen size={32} className="text-stone-300 mb-2" />
 <p className="font-display text-base font-medium text-earth ">No courses found</p>
 ...
 <tr key={course.id} className="hover:bg-stone-100 :bg-[#1a1d27] transition-colors group">
 <td className="px-6 py-4">
 <p className="text-sm font-medium text-earth line-clamp-1">{course.title}</p>
 </td>
 <td className="px-6 py-4">
 <span className="text-sm text-warm-brown ">{course.author}</span>
 </td>
 <td className="px-6 py-4">
 ...
 <h3 className="font-display text-xl font-bold text-earth mb-2">Delete Course</h3>
