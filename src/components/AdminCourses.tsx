  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Courses</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Manage your educational courses and content.</p>
        </div>
        <button 
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                    <div className="flex flex-col items-center justify-center gap-2">
                      <BookOpen size={32} className="text-gray-300 dark:text-gray-600 mb-2" />
                      <p className="text-base font-medium text-gray-900 dark:text-white">No courses found</p>
                ...
                filteredCourses.map((course) => (
                  <tr key={course.id} className="hover:bg-gray-50 dark:hover:bg-[#1a1d27] transition-colors group">
                    <td className="px-6 py-4">
                      <p className="text-sm font-medium text-gray-900 dark:text-white line-clamp-1">{course.title}</p>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-600 dark:text-gray-300">{course.author}</span>
                    </td>
                    <td className="px-6 py-4">
