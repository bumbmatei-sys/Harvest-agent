...
const AllNews: React.FC<AllNewsProps> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f8f9fa] dark:bg-[#1a1d27]">
      <div className="sticky top-0 z-20 bg-white/80 dark:bg-[#1a1d27]/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-4 py-3 flex items-center gap-3">
        <button 
          onClick={onBack}
        ...
        <span className="font-medium text-gray-900 dark:text-white truncate">News & Updates</span>
      </div>
        ...
        {loading ? (
          ...
          posts.map(post => (
            <div key={post.id} className="bg-white dark:bg-[#252a36] rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <div className="text-gray-800 dark:text-gray-200 text-sm whitespace-pre-wrap mb-3">
                {post.content}
              </div>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full relative overflow-hidden rounded-xl border p-3 text-left transition-all ${
                          isMyVote 
                            ? 'border-[#d4a017] bg-[#fcefc7] dark:bg-[#d4a017]/20' 
                            : 'border-gray-200 dark:border-gray-700 hover:border-[#d4a017] dark:hover:border-[#d4a017]'
                        }`}
                      >
                        {hasVoted && (
                          <div 
                        ...
                        <div className="relative flex justify-between items-center z-10">
                          <span className={`text-sm font-medium ${isMyVote ? 'text-[#d4a017] dark:text-[#e6b325]' : 'text-gray-700 dark:text-gray-300'}`}>
                            {option.text}
                          </span>
                          {hasVoted && (
      ...
      {attendingPostId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#252a36] rounded-2xl p-6 w-full max-w-md shadow-xl">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Join Event</h3>
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-[#d4a017] outline-none"
