...
const FAQItem: React.FC<{ 
 ...
 <button 
 onClick={onToggle}
 className="w-full flex items-center justify-between p-5 text-left hover:bg-stone-100 :bg-gray-800/50 transition-colors"
 >
 <h4 className="text-sm font-bold text-earth pr-4">{question}</h4>
 {isOpen ? (
 ...
 {isOpen && (
 <div className="px-5 pb-5 text-sm text-warm-brown leading-relaxed animate-in slide-in-from-top-2 duration-200">
 {answer}
 </div>
 )}
 </div>
...
const FAQModal: React.FC<FAQModalProps> = ({ isOpen, onClose }) => {
 ...
 answer: (
 <>
 Harvest AI is a specialized companion designed to answer the questions of &quot;baby Christians&quot; in a safe, biblically sound environment. Unlike generic AI tools, <strong className="text-earth ">Harvest AI is locally trained using healthy, trusted theological resources.</strong> We have carefully curated the data it learns from to ensure it provides life-giving, orthodox answers. Its primary function is to point users back to the Word of God, the Holy Spirit, and the local church.
 </>
 )
 },
 {
 ...
 <li><strong className="text-earth ">Level 1:</strong> The Foundations (New Life in Christ)</li>
 <li><strong className="text-earth ">Level 2:</strong> Walking in the Spirit</li>
 <li><strong className="text-earth ">Level 3:</strong> Character & The Word</li>
 <li><strong className="text-earth ">Level 4:</strong> Commissioned to Serve</li>
 </ul>
 ...
 answer: (
 <>
 We welcome biblically-based churches and ministries to join our global network. You can enroll through our <strong className="text-earth ">Church Partner Portal</strong>. Once verified, your location will be visible to new converts in your immediate area, helping them find their spiritual family.
 </>
 )
 },
 {
 ...
 <h2 className="text-lg font-bold text-earth flex-1 text-center pr-8 font-display">FAQ</h2>
 </div>

 <div className="flex-1 overflow-y-auto p-4 pb-12">
 <div className="text-center mb-8 mt-4">
 <h2 className="text-2xl font-bold text-[#1a202c] mb-2 font-display">Frequently Asked Questions</h2>
 <p className="text-warm-brown text-sm">Everything you need to know about the Harvest App.</p>
 </div>
