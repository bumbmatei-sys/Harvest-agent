    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#f8f9fa] dark:bg-[#1a1d27]">
      ...
      <div className="bg-white dark:bg-[#252a36] px-4 py-3 flex items-center justify-between shadow-sm z-10">
        <div className="flex items-center gap-3">
          <button 
            onClick={onClose}
            className="p-2 -ml-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors rounded-full hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            <ArrowLeft size={20} />
          </button>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 bg-white dark:bg-[#252a36] border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none transition-all text-base font-medium"
            />
          </div>

          {/* Category */}
          <div className="bg-white dark:bg-[#252a36] p-3 rounded-lg border border-gray-200 dark:border-gray-700 space-y-2">
            ...
            {!isAddingCategory ? (
              <div className="flex gap-2">
                <select 
                  ...
                  className="flex-1 px-3 py-1.5 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none transition-all text-sm"
                >
                ...
                {category && (
                  <button 
                    ...
                    className="px-2.5 py-1.5 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors flex items-center justify-center"
                ...
                <button 
                  ...
                  className="px-3 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex items-center gap-1.5 text-sm"
                >
                  <Plus size={16} />
              ...
              <div className="flex items-center gap-1.5 w-full">
                <input 
                  ...
                  className="flex-1 min-w-0 w-full px-2 py-1.5 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none transition-all text-sm"
                  autoFocus
                />
                <button 
                ...
                <button 
                  ...
                  className="flex-shrink-0 p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                >
                  <X size={16} />
                </button>
              </div>
          ...
          <div className="bg-white dark:bg-[#252a36] p-3 rounded-lg border border-gray-200 dark:border-gray-700 space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5 mb-2">
              {tags.map(tag => (
                <span key={tag} className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full text-xs">
                  {tag}
            ...
            <input 
              ...
              className="w-full px-3 py-1.5 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none transition-all text-sm"
            />
          </div>
      ...
      {/* Bottom Action Bar */}
      <div className="bg-white dark:bg-[#252a36] border-t border-gray-100 dark:border-gray-800 p-3 pb-safe w-full z-20 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row gap-2">
          <button 
            onClick={() => handleSave('draft')}
            disabled={isSaving}
            className="flex-1 py-2 px-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1.5 disabled:opacity-50"
          >
            <Save size={16} />
