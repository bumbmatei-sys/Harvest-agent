  ...
  return (
    <div className="space-y-4">
      ...
      {submissions.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-gray-400 dark:text-gray-500 bg-white dark:bg-[#252a36] rounded-2xl border border-gray-100 dark:border-gray-800">
        ...
        return (
          <div key={sub.id} className={`bg-white dark:bg-[#252a36] rounded-2xl shadow-sm border ${isPending ? 'border-[#d4a017]/30 dark:border-[#d4a017]/20' : 'border-gray-100 dark:border-gray-800'} overflow-hidden transition-all duration-300`}>
            <div 
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2 mb-1">
                  <h3 className={`text-sm font-bold truncate ${isPending ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'}`}>
            ...
            {isExpanded && (
              <div className="p-4 border-t border-gray-50 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/20 animate-in slide-in-from-top-2 duration-200">
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                  {deleteConfirmId === sub.id ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-lg transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                  ...
                  {isPending ? (
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-green-600 bg-green-50 hover:bg-green-100 dark:bg-green-900/20 dark:hover:bg-green-900/40 rounded-lg transition-colors"
                    >
                      <CheckCircle size={16} />
                      Mark Resolved
                    </button>
