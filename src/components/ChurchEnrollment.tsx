...
const ChurchEnrollment: React.FC<ChurchEnrollmentProps> = ({ onBack, initialData, onSave }) => {
 ...
 <p className="text-sm text-muted mb-4">Add the regular services and meetings throughout the week.</p>
 ...
 <div className="w-full md:w-1/4">
 <label className="block text-xs font-bold text-strong mb-1">Time</label>
 <input 
 type="text" 
 value={service.time}
 ...
 <label className="block text-xs font-bold text-strong mb-1">Service Name</label>
