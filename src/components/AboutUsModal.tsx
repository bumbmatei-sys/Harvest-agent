...
const AboutUsModal: React.FC<AboutUsModalProps> = ({ isOpen, onClose, onOpenPartner }) => {
 ...
 <h2 className="text-lg font-bold text-strong flex-1 text-center pr-8 font-display">About Us</h2>
 </div>
 ...
 <h3 className="text-xl font-bold text-strong font-display">The Vision</h3>
 </div>
 
 <div className="bg-surface-raised rounded-3xl p-6 shadow-sm border border-line ">
 <h4 className="text-lg font-bold text-strong mb-4 font-display">
 The Digital Foundation for the Great Commission
 </h4>
 
 <div className="space-y-4 text-sm text-muted leading-relaxed">
 <p>
 Every week, hundreds of thousands of people across the globe raise their hands to accept Jesus as their Savior. This unprecedented momentum is a glorious sign of our times. However, our hearts are focused on a vital question: <strong className="text-strong ">&quot;What is the retention percentage?&quot;</strong>
 </p>
 <p>
 ...
 <div className="pl-4 border-l-4 border-[color-mix(in_srgb,var(--brand-color)_20%,white)] italic text-body mt-6">
 ...
 <h3 className="text-xl font-bold text-strong font-display">About Us</h3>
 </div>
 ...
 <div className="w-full h-full flex items-center justify-center text-faint font-bold text-xl">
 MB
 </div>
 )}
 </div>
 <div>
 <h5 className="font-bold text-strong ">Matei Bumb</h5>
