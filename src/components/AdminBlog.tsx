  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Blog Posts</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Manage your blog content and publications.</p>
        </div>
        <button 
      ...
      <div className="bg-white dark:bg-[#252a36] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none text-gray-900 dark:text-white transition-all"
            />
          </div>
          <div className="relative min-w-[160px]">
            ...
            <select 
              ...
              className="w-full pl-10 pr-8 py-2 bg-gray-50 dark:bg-[#1a1d27] border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] focus:border-transparent outline-none text-gray-900 dark:text-white appearance-none transition-all"
            >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/50 dark:bg-[#1a1d27]/50 border-b border-gray-100 dark:border-gray-800">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {loading ? (
                ...
                filteredPosts.map((post) => (
                  <tr key={post.id} className="hover:bg-gray-50 dark:hover:bg-[#1a1d27] transition-colors group">
                    <td className="px-6 py-4">
                      <p className="text-sm font-medium text-gray-900 dark:text-white line-clamp-1">{post.title}</p>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-600 dark:text-gray-300">{post.category}</span>
                    </td>
                    <td className="px-6 py-4">
