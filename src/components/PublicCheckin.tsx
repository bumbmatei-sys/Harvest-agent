    ...
    <Shell>
      <form onSubmit={handleSubmit} className="bg-surface-raised rounded-[14px] shadow-xs border border-line-subtle p-6" style={{ paddingBottom: 120 }}>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-body mb-1.5">First Name<span className="text-red-500 ml-0.5">*</span></label>
          ...
          <div>
            <label className="block text-sm font-medium text-body mb-1.5">Email <span className="text-faint font-normal">(optional)</span></label>
