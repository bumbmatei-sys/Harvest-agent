...
export function CourseCard({ course, authors, onClick, completed }: CourseCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="flex gap-3.5 p-3.5 bg-surface-raised border border-line rounded-xl cursor-pointer transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 mb-3"
    >
      {/* Thumbnail */}
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center">
        ...
        <div className="flex items-center gap-3 text-xs text-faint font-medium">
          {totalLessons > 0 && (
        ...
        {progress > 0 && (
          <div className="mt-2 h-[3px] bg-surface-sunken rounded-full overflow-hidden">
            <div
