  ...
  return (
    ...
    >
      ...
      <div
        {...attributes}
        {...listeners}
        className="cursor-grab active:cursor-grabbing text-stone-300 hover:text-faint touch-none"
      ...
      <span className="text-sm font-semibold text-body truncate">{item.label}</span>
    </div>
  );
};
  ...
  return (
    <div className="fixed inset-0 z-[300] bg-surface-tint flex flex-col">
      ...
      <div className="bg-surface-raised px-4 py-3 flex items-center justify-between shadow-sm border-b border-line flex-shrink-0">
        ...
        <h2 className="font-display text-base font-bold text-strong">Customize Navigation</h2>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5">
        ...
        >
          ...
          <section className="mb-6">
            <div className="flex items-center justify-between mb-1.5">
              <h3 className="text-xs font-bold uppercase tracking-wider text-muted">Bottom Bar</h3>
              <span
            ...
            <p className="text-xs text-faint mb-3">Up to 4 items appear in the bottom navigation bar.</p>
            ...
            <SortableContext items={barItems.map((i) => i.id)} strategy={verticalListSortingStrategy}>
              <div id="bar-droppable" className="space-y-2 min-h-[60px]">
                ...
                {barItems.length === 0 && (
                  <div className="h-14 rounded-[14px] border-2 border-dashed border-line flex items-center justify-center text-xs text-faint">
                    Drag items here
                  </div>
                )}
              </div>
          ...
          {/* More Drawer section */}
          <section className="mb-6">
            <h3 className="text-xs font-bold uppercase tracking-wider text-muted mb-1.5">More Drawer</h3>
            <p className="text-xs text-faint mb-3">These items appear in the More sheet.</p>
        ...
        {/* Footnote */}
        <div className="bg-surface-raised rounded-[14px] p-3 border border-line text-xs text-faint">
