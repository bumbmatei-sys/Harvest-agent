      ...
      */}
      <div data-modal-container="dialog-panel" className="bg-surface w-full sm:w-[500px] max-h-[90vh] rounded-t-3xl sm:rounded-3xl overflow-y-auto flex flex-col relative animate-slide-up sm:animate-fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bg-[#0b1121] pt-12 pb-8 px-6">
          ...
          <p className="text-faint text-sm mt-1">Unlimited churches, custom pricing, dedicated support</p>
        </div>
        ...
        <div className="px-6 py-6">
          {success ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-bold text-strong mb-2 font-display">{"We'll be in touch!"}</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-body mb-1 block">Message</label>
                <textarea
                  value={message}
