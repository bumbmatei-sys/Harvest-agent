...
const PrivacyTermsModal: React.FC<PrivacyTermsModalProps> = ({ isOpen, onClose }) => {
 ...
 <h2 className="text-lg font-bold text-earth flex-1 text-center pr-8 font-display">Privacy & Terms</h2>
 </div>

 <div className="flex-1 overflow-y-auto p-4 pb-12">
 {/* Tabs */}
 <div className="flex bg-white rounded-2xl p-1 mb-6 shadow-sm border border-stone-200 ">
 <button
 ...
 : 'text-warm-brown hover:text-[color:var(--text-body)] :text-stone-300'
 }`}
 >
 Privacy Policy
 </button>
 ...
 {activeTab === 'privacy' ? (
 <div className="space-y-6 text-sm text-warm-brown leading-relaxed animate-in fade-in duration-300">
 <div>
 <h3 className="text-xl font-bold text-earth mb-1">Privacy Policy</h3>
 <p className="text-xs text-warm-brown ">Last Updated: December 2025</p>
 </div>

 <div>
 <h4 className="text-base font-bold text-earth mb-2">Our Commitment to Your Journey</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">Information We Collect</h4>
 <ul className="space-y-3 list-disc pl-4 marker:text-stone-300 :text-warm-brown">
 <li>
 <strong className="text-earth ">Account Information:</strong> Name, email address, and basic profile details provided during registration.
 </li>
 <li>
 <strong className="text-earth ">Spiritual Progress:</strong> Data regarding your progress in all courses to help you pick up where you left off.
 </li>
 <li>
 <strong className="text-earth ">Location Data:</strong> With your permission, we use your GPS location solely to display the closest registered churches and communities on our map.
 </li>
 <li>
 <strong className="text-earth ">AI Interactions:</strong> Conversations with the Harvest AI are processed to provide theological guidance. These interactions are stored to improve the AI&apos;s accuracy and are never sold to third parties.
 </li>
 </ul>
 </div>

 <div>
 <h4 className="text-base font-bold text-earth mb-2">How We Use Your Information</h4>
 <ul className="space-y-3 list-disc pl-4 marker:text-stone-300 :text-warm-brown">
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">Data Sharing and Disclosure</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">Security</h4>
 <p>
 ...
 <div className="space-y-6 text-sm text-warm-brown leading-relaxed animate-in fade-in duration-300">
 <div>
 <h3 className="text-xl font-bold text-earth mb-1">Terms of Use</h3>
 <p className="text-xs text-warm-brown ">Last Updated: December 2025</p>
 </div>

 <div>
 <h4 className="text-base font-bold text-earth mb-2">1. Acceptance of Terms</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">2. Use License</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">3. The Harvest AI Disclaimer</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">4. Community Conduct</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">5. Church Map & Third-Party Ministries</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">6. Free Access & Partnership</h4>
 <p>
 ...
 <div>
 <h4 className="text-base font-bold text-earth mb-2">7. Limitation of Liability</h4>
 <p>
