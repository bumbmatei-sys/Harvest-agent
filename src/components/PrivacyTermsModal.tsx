  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#f8f9fa] dark:bg-[#1a1d27] animate-in slide-in-from-bottom-full duration-300 overflow-hidden">
      ...
      <div className="flex items-center px-4 py-4 bg-white dark:bg-[#1a1d27] border-b border-gray-100 dark:border-gray-800 sticky top-0 z-10">
        ...
        <h2 className="text-lg font-bold text-gray-900 dark:text-white flex-1 text-center pr-8">Privacy & Terms</h2>
      </div>

      <div className="flex-1 overflow-y-auto p-4 pb-12">
        {/* Tabs */}
        <div className="flex bg-white dark:bg-[#252a36] rounded-2xl p-1 mb-6 shadow-sm border border-gray-100 dark:border-gray-800">
          <button
            onClick={() => setActiveTab('privacy')}
            className={`flex-1 py-3 text-sm font-bold rounded-xl transition-colors ${
              activeTab === 'privacy'
                ? 'bg-[#fdf8e7] dark:bg-[#d4a017]/10 text-[#d4a017]'
        ...
        <div className="bg-white dark:bg-[#252a36] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
          {activeTab === 'privacy' ? (
            <div className="space-y-6 text-sm text-gray-600 dark:text-gray-300 leading-relaxed animate-in fade-in duration-300">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Privacy Policy</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">Last Updated: December 2025</p>
              </div>

              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">Our Commitment to Your Journey</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">Information We Collect</h4>
                <ul className="space-y-3 list-disc pl-4 marker:text-gray-300 dark:marker:text-gray-600">
                  <li>
                    <strong className="text-gray-900 dark:text-white">Account Information:</strong> Name, email address, and basic profile details provided during registration.
                  </li>
                  <li>
                    <strong className="text-gray-900 dark:text-white">Spiritual Progress:</strong> Data regarding your progress in all courses to help you pick up where you left off.
                  </li>
                  <li>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">How We Use Your Information</h4>
                <ul className="space-y-3 list-disc pl-4 marker:text-gray-300 dark:marker:text-gray-600">
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">Data Sharing and Disclosure</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">Security</h4>
                <p>
            ...
            <div className="space-y-6 text-sm text-gray-600 dark:text-gray-300 leading-relaxed animate-in fade-in duration-300">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Terms of Use</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">Last Updated: December 2025</p>
              </div>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">2. Use License</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">3. The Harvest AI Disclaimer</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">4. Community Conduct</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">5. Church Map & Third-Party Ministries</h4>
                <p>
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">6. Free Access & Partnership</h4>
                <p>
