...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate }) => {
 ...
 className="w-8 h-8 flex items-center justify-center rounded-full bg-[#fdf8ed] text-[#d4a017] hover:bg-[#fcefc7] :bg-[#3a301c] transition-colors relative"
 >
 ...
 className={`text-gray-500 hover:text-gray-900 :text-white transition-colors relative ${activeTab === 'inbox' ? 'text-[#d4a017] ' : ''}`}
 >
 <Inbox size={24} />
 {unreadCount > 0 && (
 ...
 isActive ? 'text-[#e6b325]' : 'text-gray-400 hover:text-gray-600 :text-gray-300'
 }`}
 >
 <Icon 
 size={24} 
