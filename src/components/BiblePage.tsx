...
function VerseActionSheet({
 verseAction, highlighted,
 onHighlight, onRemoveHighlight, onCopy, onShare, onClose,
 ...
 <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "14px 16px 32px", gap: 10 }}>
 {[
 ...
 * { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 {activeVerse && (
 <VerseActionSheet verseAction={activeVerse} highlighted={highlighted}
